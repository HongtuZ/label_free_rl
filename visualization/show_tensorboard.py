...
if __name__ == '__main__':
    ...
    base_dir = ['logs/certain/point-robot/focal-certain_20250424_133453', 'logs/certain/point-robot/focal-certain_20250429_153346',
                 'logs/certain/point-robot/classifier-certain_20250424_133510', 'logs/certain/point-robot/classifier-certain_20250429_153647',
                 'logs/certain/point-robot/unicorn-certain_20250424_133732', 'logs/certain/point-robot/unicorn_20250424_133406']
    
    base_dirs = [base_dir]
    
    names = ['focal', 'focal+ours', 'classifier', 'classifier+ours',  'unicorn', 'unicorn+ours']
    ...
    for base_dir in base_dirs:
        ...
        visualize_tensorboard(base_dir, ['Eval_All_task/zero_shot_return'], plot_type, save_path+'1.pdf', names, ["First Episode Test"], num_train_steps_per_itr)
        visualize_tensorboard(base_dir, ['Eval_All_task/one_shot_return'], plot_type, save_path+'2.pdf', names, ["Second Episode Test"], num_train_steps_per_itr)
